...
```md
========================================
  KONTEXT FÜR ISSUE #56
  Repo: Alexmistrator/gitea-agent
  Branch: chore/issue-56-2-ast-skelett
========================================

Du arbeitest auf Branch: chore/issue-56-2-ast-skelett
NIEMALS auf main committen.
Nach jeder Dateiänderung: git add <datei> && git commit -m "..."
Arbeitsverzeichnis: /home/ki02/gitea-agent

========================================
  PR ERSTELLEN (nach Abschluss):
  cd /home/ki02/gitea-agent && GITEA_REPO=Alexmistrator/gitea-agent python3 /home/ki02/gitea-agent/agent_start.py --self --pr 56 --branch chore/issue-56-2-ast-skelett --summary "..."
========================================
...
- [ ] git push origin chore/issue-56-2-ast-skelett

## Commit-Template
<typ>: <beschreibung> (closes #56)

## PR-Befehl
python3 agent_start.py --pr 56 --branch chore/issue-56-2-ast-skelett --summary "..."

## Gitea
http://192.168.1.60:3001/Alexmistrator/gitea-agent/issues/56
...
## _create_issue_github.py  *(64 Zeilen)*
  *(keine Klassen/Funktionen erkannt)*
> Volltext: `python3 agent_start.py --get-slice _create_issue_github.py:1-64`
...
## agent_start.py  *(3927 Zeilen)*
  ...
  - Funktion `cmd_watch` Zeilen 3086-3222  `def cmd_watch(interval_minutes: int = 60, patch_mode: bool = False) -> None:`
  - Funktion `_dashboard_event` Zeilen 3230-3237  `def _dashboard_event(context: str = "") -> None:`
  - Funktion `cmd_install_service` Zeilen 3263-3308  `def cmd_install_service() -> None:`
  - Funktion `cmd_dashboard` Zeilen 3316-3322  `def cmd_dashboard() -> None:`
  - Funktion `cmd_auto` Zeilen 3324-3416  `def cmd_auto() -> None:`
  - Funktion `_apply_auto_approve` Zeilen 3424-3452  `def _apply_auto_approve() -> None:`
  - Funktion `cmd_doctor` Zeilen 3459-3560  `def cmd_doctor() -> None:`
  - Funktion `cmd_setup` Zeilen 3567-3718  `def cmd_setup() -> None:`
  - Funktion `main` Zeilen 3721-3923  `def main():`
  - Funktion `_sym_map` Zeilen 2882-2884  `def _sym_map(content: str) -> dict[str, dict]:`
  - Funktion `_chk` Zeilen 3465-3466  `def _chk(name: str, status: str, detail: str = "", fix: str = "") -> None:`
  - Funktion `_ask` Zeilen 3571-3574  `def _ask(prompt: str, default: str = "") -> str:`
  - Funktion `_api_get_raw` Zeilen 3576-3583  `def _api_get_raw(url, user, token, path):`
  - Funktion `_api_post_raw` Zeilen 3585-3595  `def _api_post_raw(url, user, token, path, data: dict):`
  - Funktion `_len` Zeilen 2895-2900  `def _len(s: dict) -> int:`
> Volltext: `python3 agent_start.py --get-slice agent_start.py:1-3927`

## doctor_last.json
```json
{
  "timestamp": "2026-03-26T19:10:35",
  "summary": {
    "ok": 5,
    "warn": 1,
    "fail": 0
...
[... 1094 weitere Zeilen — --get-slice für vollständigen Code ...]
```
