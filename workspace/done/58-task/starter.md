...
---
# Issue #58 — 4 SEARCH/REPLACE
Status: 🔧 READY — Implementierung starten
Risiko: 2/4 — MITTEL — (Plan vor Implementierung)
Branch: chore/issue-58-4-search-replace

## Ziel
Titel: SEARCH/REPLACE Protokoll — chirurgisches Patchen via AST-Validierung

Ziel
LLM-agnostisches Patch-Protokoll. Kein Datei-Überschreiben mehr —
nur validierte Fragmente werden geändert.
...
- [ ] git push origin chore/issue-58-4-search-replace

## Commit-Template
<typ>: <beschreibung> (closes #58)

## PR-Befehl
python3 agent_start.py --pr 58 --branch chore/issue-58-4-search-replace --summary "..."

## Gitea
http://192.168.1.60:3001/Alexmistrator/gitea-agent/issues/58
