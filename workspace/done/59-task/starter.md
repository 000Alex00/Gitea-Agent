...
---
# Issue #59 — 5 Gitea Versionsvergleich
Status: 🔧 READY — Implementierung starten
Risiko: 2/4 — MITTEL — (Plan vor Implementierung)
Branch: chore/issue-59-5-gitea-versionsvergleich

## Ziel
Titel: Gitea-Versionsvergleich — AST-Diff bei Score-Regression

Ziel
Bei Score-Regression automatisch alte Dateiversion aus Gitea laden
und strukturell vergleichen — Ursache statt Symptom.
...
- [ ] git push origin chore/issue-59-5-gitea-versionsvergleich

## Commit-Template
<typ>: <beschreibung> (closes #59)

## PR-Befehl
python3 agent_start.py --pr 59 --branch chore/issue-59-5-gitea-versionsvergleich --summary "..."

## Gitea
http://192.168.1.60:3001/Alexmistrator/gitea-agent/issues/59
