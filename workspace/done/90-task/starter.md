...
---
# Issue #90 — [04] Projekt-Profil: project.json + Feature-Flags für modularen Betrieb
Status: 🔧 READY — Implementierung starten
Risiko: 2/4 — MITTEL — (Plan vor Implementierung)
Branch: chore/issue-90-04-projekt-profil-project-json-fea

## Ziel
## Problem

Aktuell ist alles immer aktiv — Eval-System, Watch-Loop, Auto-Issues, Changelog. Ein Projekt ohne Tests braucht kein Eval-System. Ein CLI-Tool braucht keinen Watch-Loop.
...
- [ ] git push origin chore/issue-90-04-projekt-profil-project-json-fea

## Commit-Template
<typ>: <beschreibung> (closes #90)

## PR-Befehl
python3 agent_start.py --pr 90 --branch chore/issue-90-04-projekt-profil-project-json-fea --summary "..."

## Gitea
http://192.168.1.60:3001/Alexmistrator/gitea-agent/issues/90
