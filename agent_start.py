...
def cmd_setup() -> None:
    """--setup: Interaktiver Einrichtungs-Wizard. Siehe plugins/setup_wizard.py"""
    from plugins.setup_wizard import cmd_setup as _wizard
    _wizard(_post_doctor=cmd_doctor, _post_dashboard=cmd_dashboard)
